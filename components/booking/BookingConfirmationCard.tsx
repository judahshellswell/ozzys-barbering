...
export function BookingConfirmationCard({ booking }: { booking: BookingState }) {
  ...
  return (
    <div className="text-center">
      <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#c0392b]/10 mb-6">
        <CheckCircle2 className="h-10 w-10 text-[#c0392b]" />
      </div>
      ...
      <div className="bg-[#0f0f0f] text-white rounded-xl p-6 mb-6 inline-block w-full max-w-sm">
        <div className="flex items-center justify-center gap-2 mb-1">
          <Scissors className="h-4 w-4 text-[#c0392b]" />
          <span className="text-xs text-gray-400 uppercase tracking-widest">Confirmation Code</span>
        </div>
        <p className="text-3xl font-bold tracking-widest text-[#c0392b]">
      ...
      <div className="bg-muted rounded-xl p-5 text-left mb-6 space-y-3">
        <div className="flex items-center gap-3">
          <CalendarCheck className="h-5 w-5 text-[#c0392b] shrink-0" />
          <div>
