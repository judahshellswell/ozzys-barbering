...
<head>
  ...
  <style>
    ...
    .header h1 { color: #c0392b; margin: 0; font-size: 28px; letter-spacing: 3px; font-family: Georgia, serif; }
    ...
    .code { background: #f9f6f1; border: 2px solid #c0392b; border-radius: 6px; padding: 16px; text-align: center; margin: 24px 0; }
